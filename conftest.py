...
#     firefox_options.binary = '/driver/firefox-bin'
...
# #     chrome_options.binary_location = 'C:\Users\Max\PycharmProjects\modul24\.pytest_cache\Chrome\chromedriver.exe'
# #     chrome_options.add_extension('/Chrome/chromedriver.exe')
